...
new TypeOfContract[]
{
            ...
            new Partner[]
            {
                new Partner {Id=1, Name = "Муниципальное унитарное предприятие \"Энергетический ресурс\" Некрасовского муниципального района", INN ="7701071", KPP="7701001", ShortName ="МУП \"Энергоресурс\"", Address = "Ярославская обл., Некрасовский р-н, рп. Некрасовское, ул. Советская, д. 175", OGRN = "1235550001", Bank ="ПАО \"Сбербанк\"", Account ="40301030000000065", CorrespondentAccount = "3010110000000022", BIK = "7752251",  DirectorName = "Иванов И.И.", DirectorNameR = "Иванова И.И.", DirectorTypeId = 1, PartnerStatusId = 1, PartnerTypeId = 1, PartnerCategoryId = 3},
                new Partner {Id=2, Name = "ООО \"Сервисное предприятие авторемонт\"", INN ="7701051", KPP="7701001", ShortName ="ООО \"Авторемонт\"", Address = "Ярославская обл., Некрасовский р-н, рп. Некрасовское, ул. Пролетарская, д. 11", OGRN = "3315350022", Bank ="ПАО \"Сбербанк\"", Account ="403221030000010072", CorrespondentAccount = "3010150000000133", BIK = "7752251",DirectorName = "Капралов Д.М.", DirectorNameR = "Капралова Д.М.", DirectorTypeId = 2, PartnerStatusId = 2, PartnerTypeId = 1, PartnerCategoryId = 3},
                new Partner {Id=3, Name = "ООО Муниципальное образовательное учреждение \"Некрасовская средняя общеобразовательная школа\"", INN ="7701031", KPP="7701002", ShortName ="МОУ \"Некрасовская средняя школа\"", Address = "Ярославская обл., Некрасовский р-н, рп. Некрасовское, ул. Матросова, д. 17", OGRN = "3411330222", Bank ="ПАО \"Сбербанк\"", Account ="403551030012010078", CorrespondentAccount = "3010250001000123", BIK = "7752251", DirectorName = "Сергеев А.Р.", DirectorNameR = "Сергеева А.Р.", DirectorTypeId = 1, PartnerStatusId = 2, PartnerTypeId = 1, PartnerCategoryId = 3},
                new Partner {Id=4, Name = "Некрасовский районный суд Ярославской области", INN ="", KPP="", ShortName ="Некрасовский районный суд Ярославской области", Address = "152260, п. Некрасовское, ул. Некрасова, д. 30", OGRN = "", Bank ="", Account ="", CorrespondentAccount = "", BIK = "", DirectorName = "", DirectorNameR = "", DirectorTypeId = 1, PartnerStatusId = 2, PartnerTypeId = 1, PartnerCategoryId = 2},
                new Partner {Id=5, Name = "Арбитражный суд Ярославской области", INN ="", KPP="", ShortName ="Арбитражный суд Ярославской области", Address = "150054, г. Ярославль, пр-т Ленина, д. 28", OGRN = "", Bank ="", Account ="", CorrespondentAccount = "", BIK = "", DirectorName = "", DirectorNameR = "", DirectorTypeId = 1, PartnerStatusId = 2, PartnerTypeId = 1, PartnerCategoryId = 2},
                new Partner {Id=6, Name = "Муниципальное унитарное предприятие «Некрасовский водохозяйственный комплекс»", INN ="", KPP="", ShortName ="МУП «НВК»", Address = "152260, Ярославская обл., рп. Некрасовское, ул. Советская, д. 178", OGRN = "", Bank ="", Account ="", CorrespondentAccount = "", BIK = "", DirectorName = "", DirectorNameR = "", DirectorTypeId = 1, PartnerStatusId = 2, PartnerTypeId = 1, PartnerCategoryId = 3}
