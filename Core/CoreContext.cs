...
new PartnerType[]
{
            ...
            {
                new ContractTemplate {Id=1, Name = "Договор (общие)", Description = "", TypeOfContractId = 5},
                new ContractTemplate {Id=2, Name = "Договор подряда", Description = "", TypeOfContractId = 1},
                new ContractTemplate {Id=3, Name = "Договор оказания услуг", Description = "", TypeOfContractId = 2}
            ...
            new Condition[]
            {
                new Condition {Id = 1, Name = "Договор contractType № __", TypeOfConditionId = 1, ContractTemplateId = 1, TypeOfStateRegId = 4},
                new Condition {Id = 2, Name = "Преамбула", Text = "customerName именуемое в дальнейшем \"Заказчик\", в лице customerDirectorTypeNameR customerDirectorNameR, действующего на основании Устава, с одной стороны, и executorName, именуемое в дальнейшем \"executor\", в лице executorDirectorTypeNameR executorDirectorNameR, действующего на основании Устава, с другой стороны, baseOfContract заключили настоящий договор о нижеследующем:", TypeOfConditionId = 2, ContractTemplateId = 1, TypeOfStateRegId = 4},

                new Condition {Id = 3, Name = "Предмет договора", TypeOfConditionId = 3, ContractTemplateId =  2, TypeOfStateRegId = 4},
                new Condition {Id = 4, Name = "Права и обязанности сторон", TypeOfConditionId = 3, ContractTemplateId = 2, TypeOfStateRegId = 4},
                new Condition {Id = 5, Name = "Ответственность сторон", TypeOfConditionId = 3, ContractTemplateId = 2, TypeOfStateRegId = 1},

                new Condition {Id = 6, Name = "Предмет договора", TypeOfConditionId = 3, ContractTemplateId =  3, TypeOfStateRegId = 4},
                new Condition {Id = 7, Name = "Права и обязанности сторон", TypeOfConditionId = 3, ContractTemplateId = 3, TypeOfStateRegId = 4},
                new Condition {Id = 8, Name = "Ответственность сторон", TypeOfConditionId = 3, ContractTemplateId = 3, TypeOfStateRegId = 1},
