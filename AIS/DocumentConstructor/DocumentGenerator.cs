...
namespace AIS
{
    public class DocumentGenerator: IDocumentGenerator
    {
        ...
        private void createParagraph(WordprocessingDocument wordDoc, string styleId, string paragraphfontSize, bool isNumbering, int numLevelReference, int numId, string justificationValue, bool isBold, string txt)
        {
        ...
        private static Paragraph GetParagraph(WordprocessingDocument wordDoc, string styleId, string paragraphfontSize, bool isNumbering, int numId, string justificationValue, string txt)
        {
            //Получаем корень документа
            MainDocumentPart mainPart = wordDoc.MainDocumentPart;
            //Получаем Body
        ...
        private static void CreateAndAddNoSpaceParagraphStyle(StyleDefinitionsPart styleDefinitionsPart, string styleId)
        {
        ...
        private static void CreateTable(WordprocessingDocument doc, Dictionary<string, string> customerProp, Dictionary<string, string> executorProp)
        {
            //Получаем корень документа
        ...
        private static void CreateDateAndPlaceTable(WordprocessingDocument doc, string place, string dateTemplate)
        {
            //Получаем корень документа
            MainDocumentPart mainPart = doc.MainDocumentPart;
